    ...
    >
        <div class="flex items-start justify-between gap-4 border-b border-slate-100 p-5 dark:border-slate-800 sm:p-6">
            <div>
                ...
                <h2 class="mt-4 text-2xl font-extrabold text-slate-950 dark:text-white">Confirm this appointment?</h2>
                <p class="mt-2 text-sm leading-6 text-slate-500 dark:text-slate-400">Review the booking details before saving the appointment.</p>
            </div>
        ...
        <div class="p-5 sm:p-6">
            <div class="grid gap-3 sm:grid-cols-2">
                <div class="rounded-2xl bg-slate-50 p-4 dark:bg-slate-800">
                    ...
                    <p class="mt-1 font-extrabold text-slate-950 dark:text-white" x-text="form.patient_name"></p>
                </div>
                <div class="rounded-2xl bg-slate-50 p-4 dark:bg-slate-800">
                    <p class="text-xs font-bold text-slate-400">Date & Time</p>
                    <p class="mt-1 font-extrabold text-slate-950 dark:text-white" x-text="form.appointment_date + ' • ' + form.selected_time"></p>
                </div>
                <div class="rounded-2xl bg-slate-50 p-4 dark:bg-slate-800">
                ...
                <div class="rounded-2xl bg-slate-50 p-4 dark:bg-slate-800">
                    ...
                    <p class="mt-1 font-extrabold text-slate-950 dark:text-white" x-text="form.priority"></p>
                </div>
            </div>
            ...
            <div class="mt-5 flex flex-col gap-3 sm:flex-row sm:justify-end">
                ...
                <button type="button" x-on:click="confirmAppointment()" class="inline-flex items-center justify-center gap-2 rounded-2xl bg-[#2F6F3E] px-4 py-3 text-sm font-extrabold text-white shadow-sm transition hover:bg-[#285f35]">
